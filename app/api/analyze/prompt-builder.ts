...

{
  ...
  "dependencyGraph": {
    "nodes": [
      { "id": "dep-1", "label": "ThemeProvider", "group": "context", "description": "Manages theme color scheme preference" },
      { "id": "dep-2", "label": "api/settings", "group": "api", "description": "Settings endpoint to persist user preference" },
      { "id": "dep-3", "label": "useTheme", "group": "hook", "description": "Hook for consuming theme context" }
    ],
    "edges": [
